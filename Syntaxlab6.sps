...
save results /outfile= 'G:\Doktorandutbildningen\Statistikkurser\2. Kvantitativ multivariat analys\Lab 6\Screedata.sav' / var=root rawdata means percntyl.

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.

GET file='G:\Doktorandutbildningen\Statistikkurser\2. Kvantitativ multivariat analys\Lab 6\Screedata.sav'.
TSPLOT VARIABLES= rawdata means percntyl /ID= 

*all questions predicting liberal
...
*Factor analysis max lik 5 factors no rotation
...
*EFA max lik 5 factors Promax rotation
...
*EFA max lik 4 factors Promax rotation
...
*EFA max lik 3 factors Promax rotation
...
*EFA max lik 2 factors Promax rotation
...
*EFA max lik Final 2 factor solution Promax rot, with questions 1, 3, 7, 8, 16, 18, 24, 28 excluded

FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar19 ar20 ar21 ar22 ar23 ar25 
    ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar19 ar20 ar21 ar22 ar23 ar25 
    ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER FAC1_Scores FAC2_Scores.
